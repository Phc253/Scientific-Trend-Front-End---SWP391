...
import { Link, useLocation, Outlet } from "react-router-dom"; // 1. Import Outlet, xóa children
import axios from "axios";

// 2. Bỏ { children } trong props, để React.FC trống
    ...
    <div className="flex min-h-screen bg-[#f7fafc]">
      ...
      <aside className="w-64 bg-white border-r border-[#ebeef0] flex flex-col fixed h-full z-30">
        ...
        <div className="p-4 border-t border-[#ebeef0] space-y-3">
          {/* (Giữ nguyên phần nội dung User Info của bạn) */}
      ...
      <div className="flex-1 pl-64 flex flex-col min-h-screen">
        ...
        {/* 3. Render nội dung bằng Outlet thay vì {children} */}
